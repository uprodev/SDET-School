...
<section class="take-course">
    <div class="bg">
        <img src="<?php echo get_template_directory_uri() . '/img/bg-11-1.png' ?>" alt="<?php echo $title; ?>"
            class="img-desc">
        <img src="<?php echo get_template_directory_uri() . '/img/bg-11-2.png' ?>" alt="<?php echo $title; ?>"
            class=" img-tab">
        <img src="<?php echo get_template_directory_uri() . '/img/bg-11-3.png' ?>" alt="<?php echo $title; ?>"
            class="img-mob">
    </div>
    <div class="content-width">
        ...
        ?>
            ...
            <div class="item item-<?php echo $counter; ?>">
              ...
              ?>
                <div class="btn-wrap">
                    <a class="btn-default" href="<?php echo esc_url($link_url); ?>"
